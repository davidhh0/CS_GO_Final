...
def predict(n_classes,weightfile,imgfile,namesfile):
    import torch
    from PIL import Image
    ...
    from Final_Model_Google_Colab.pytorch_YOLOv4.tool.utils import do_detect,plot_boxes,load_class_names
    boxes = do_detect(model, sized, 0.5, n_classes, 0.4, 0)

    class_names = load_class_names(namesfile)
    plot_boxes(img, boxes, f'predicted_images/{imgfile.split("/")[-1]}', class_names)
